...
% Plotting: 6 subplots (3 for nonstiff, 3 for stiff)
figure('Color', 'w');
colors = lines(2); % Only two solvers: nonstiff and stiff

% Nonstiff (left column)
subplot(3,2,1); % Vc nonstiff
hold on;

plot(t_results{2}, Vc_results{2}, 'Color', colors(1,:), 'LineWidth', 1.5, ...
    'DisplayName', sprintf('Solver = %s', varstep_solvers(2)));
...
hold on;
plot(t_results{2}, iL1_results{2}, 'Color', colors(1,:), 'LineWidth', 1.5, ...
    'DisplayName', sprintf('Solver = %s', varstep_solvers(2)));
...
hold on;
plot(t_results{2}, iL2_results{2}, 'Color', colors(1,:), 'LineWidth', 1.5, ...
    'DisplayName', sprintf('Solver = %s', varstep_solvers(2)));
...
hold on;
plot(t_results{1}, Vc_results{1}, 'Color', colors(2,:), 'LineWidth', 1.5, ...
    'DisplayName', sprintf('Solver = %s', varstep_solvers(1)));
ylabel('V_C(t) [kV]', 'Color', 'k');
...
hold on;
plot(t_results{1}, iL1_results{1}, 'Color', colors(2,:), 'LineWidth', 1.5, ...
    'DisplayName', sprintf('Solver = %s', varstep_solvers(1)));
ylabel('i_{L1}(t) [A]', 'Color', 'k');
...
hold on;
plot(t_results{1}, iL2_results{1}, 'Color', colors(2,:), 'LineWidth', 1.5, ...
    'DisplayName', sprintf('Solver = %s', varstep_solvers(1)));
ylabel('i_{L2}(t) [A]', 'Color', 'k');
xlabel('Time (s)', 'Color', 'k');
