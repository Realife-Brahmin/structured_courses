...
\usepackage{cleveref} % for \cref references

\begin{document}

\section*{1) Shunt Harmonic Filter Calculations}
...
% Transient response (variable-based)
\[
\boxed{
  x(t) = u_0 \left[1 - \frac{1}{\sqrt{1-\zeta^2}} e^{-\zeta \omega_n t} \sin(\omega_d t + \phi)\right]
}
\]

% Transient response (numeric)
\[
\boxed{
