...
\subsection*{Step 1: Determine Order of Convergence from Table}
...
Once `sufficient closeness' to $r$ is determined, I can employ a tolerance on the absolute (approximate) error value, say $\epsilon$,. I can then stop the iterations when my approximate $e_n$ falls below this threshold and conclude that my approximate $x_n \approx r$.