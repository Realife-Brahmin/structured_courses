...
Since $F'(x) = 2 - 2qx$ is monotonically decreasing (as $q > 0$), we can verify that $F'(a) = 2 - 2q \cdot \frac{1}{2q} = 1$ and $F'(b) = 2 - 2q \cdot \frac{3}{2q} = -2$. This ensures that $|F'(x)| < 1$ throughout the open interval $(a,b)$.
...
\end{tikzpicture}
\caption{Monotonic behavior of $F'(x) = 2-2qx$ showing convergence condition $|F'(x)| < 1$ satisfied in $(a,b)$}
