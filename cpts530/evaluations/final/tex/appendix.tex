...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/p01-code-omp-part1.png}
\caption{OMP Implementation Part 1: Hard thresholding operator $H_s(\mathbf{x})$ and the beginning of the OMP function with initialization and correlation computation.}
\label{fig:p01_omp_part1}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/p01-code-omp-part2.png}
\caption{OMP Implementation Part 2: Column selection using normalized correlations, support update, and least squares solution via pseudo-inverse.}
\label{fig:p01_omp_part2}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/p01-code-omp-part3.png}
\caption{OMP Implementation Part 3: Residual update, convergence checking, and main execution loop for testing matrices A and B with varying sparsity levels.}
